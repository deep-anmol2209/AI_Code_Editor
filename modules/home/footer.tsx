...
export function Footer() {
  ...
  return (
    ...
    <footer className="border-t border-zinc-200 dark:border-zinc-800 ">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-8 flex  text-gray-700 dark:text-gray-300 hover:text-fuchsia-500 transition-colors flex-col items-center space-y-6 text-center">
